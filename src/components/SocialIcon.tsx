  ...
  return (
    <>
      <HrefLink page="https://www.instagram.com/atelieternaarte/">
        <img src={instagramIcon} alt="" className="h-20 socialicons instagram"/>
      </HrefLink>
    </>
  );
};
  ...
  return (
    <>
      <HrefLink page="https://www.facebook.com/atelieternaarte/">
        <img src={facebookIcon} alt="" className="h-20 socialicons facebook"/>
      </HrefLink>
    </>
  );
};
  ...
  return (
    <>
      <HrefLink page="https://api.whatsapp.com/send?1=pt_BR&phone=5511942285121">
        <img src={whatsappIcon} alt="" className="h-20 socialicons whatsapp"/>
      </HrefLink>
    </>
  );
};
